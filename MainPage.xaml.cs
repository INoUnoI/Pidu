...
namespace Pidu
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        public void lisaButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                var dialog = new MessageDialog("Tekstbox ei tohi olla tühi");
                dialog.ShowAsync();
            }
        }
        ...
        {
            korter1.eemaladaInimene(textbox1.Text);
            textbox1.Text = "";
            textblock1.Text = korter1.kuvaInimesed();
        }
    }
